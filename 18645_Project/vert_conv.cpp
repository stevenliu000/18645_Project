...
#define kernel_veritcal_1(src_ptr_v, i_rows, j_cols, pad_size_v, n_col_v, k_ptr_v, s0_v, s1_v, s2_v, s3_v, s4_v, s5_v, s6_v, s7_v, k0_v, k1_v, k2_v, k3_v, k4_v, k5_v, k6_v, k7_v) \
...
#define kernel_veritcal_2(src_ptr_v, i_rows, j_cols, pad_size_v, n_col_v, k_ptr_v, s0_v, s1_v, s2_v, s3_v, s4_v, s5_v, s6_v, s7_v, k0_v, k1_v, k2_v, k3_v, k4_v, k5_v, k6_v, k7_v) \
...
#define kernel_veritcal_3(src_ptr_v, i_rows, j_cols, pad_size_v, n_col_v, k_ptr_v, s0_v, s1_v, s2_v, s3_v, s4_v, s5_v, s6_v, s7_v, k0_v, k1_v, k2_v, k3_v, k4_v, k5_v, k6_v, k7_v) \
...
#define kernel_veritcal_4(src_ptr_v, i_rows, j_cols, pad_size_v, n_col_v, k_ptr_v, s0_v, s1_v, s2_v, s3_v, s4_v, s5_v, s6_v, s7_v, k0_v, k1_v, k2_v, k3_v, k4_v, k5_v, k6_v, k7_v) \
...
#define kernel_veritcal_5(src_ptr_v, i_rows, j_cols, pad_size_v, n_col_v, k_ptr_v, s0_v, s1_v, s2_v, s3_v, s4_v, s5_v, s6_v, s7_v, k0_v, k1_v, k2_v, k3_v, k4_v, k5_v, k6_v, k7_v) \
...
#define kernel_veritcal_6(src_ptr_v, i_rows, j_cols, pad_size_v, n_col_v, k_ptr_v, s0_v, s1_v, s2_v, s3_v, s4_v, s5_v, s6_v, s7_v, k0_v, k1_v, k2_v, k3_v, k4_v, k5_v, k6_v, k7_v) \
...
#define kernel_veritcal_7(src_ptr_v, i_rows, j_cols, pad_size_v, n_col_v, k_ptr_v, s0_v, s1_v, s2_v, s3_v, s4_v, s5_v, s6_v, s7_v, k0_v, k1_v, k2_v, k3_v, k4_v, k5_v, k6_v, k7_v) \
...
#define kernel_veritcal(src_ptr_v, i_rows, j_cols, pad_size_v, n_col_v, k_ptr_v, s0_v, s1_v, s2_v, s3_v, s4_v, s5_v, s6_v, s7_v, k0_v, k1_v, k2_v, k3_v, k4_v, k5_v, k6_v, k7_v) \
...
//            int i = index_transform(i_with_padding, dst_row, pad_size);
            // printf("i:   %i\n\n", i);
        for (int j_ = range.start; j_ < range.end; j_ += 1) {
            j = j_*16;
            for (int i = 0; i < dst_row; i += 1) {
                ...
                for (k = 0; k < num_of_simd_for_one_kernel - 1; k++) {
                    ...
                    kernel_veritcal(src_ptr_v, (i+k*8), j, pad_size, src_col, k_ptr_v, s0, s1, s2, s3, s4, s5, s6, s7, k0, k1, k2, k3, k4, k5, k6, k7);
                    sum_to_d(d0, s0);
                    kernel_veritcal(src_ptr_v, (i+k*8), j+8, pad_size, src_col, k_ptr_v, s0, s1, s2, s3, s4, s5, s6, s7, k0, k1, k2, k3, k4, k5, k6, k7);
                    sum_to_d(d1, s0);
                }
                ...
                switch (partial_SIMD_num) {
                    case 1:
                        ...
                        kernel_veritcal_1(src_ptr_v, (i+k*8), j, pad_size, src_col, k_ptr_v, s0, s1, s2, s3, s4, s5, s6, s7, k0, k1, k2, k3, k4, k5, k6, k7);
                        sum_to_d(d0, s0);
                        kernel_veritcal_1(src_ptr_v, (i+k*8), j+8, pad_size, src_col, k_ptr_v, s0, s1, s2, s3, s4, s5, s6, s7, k0, k1, k2, k3, k4, k5, k6, k7);
                        sum_to_d(d1, s0);
                        break;
                    case 2:
                        load_kernel_vertical_2(k_ptr_v + 8 * k, k0, k1, k2, k3, k4, k5, k6, k7);
                        kernel_veritcal_2(src_ptr_v, (i+k*8), j, pad_size, src_col, k_ptr_v, s0, s1, s2, s3, s4, s5, s6, s7, k0, k1, k2, k3, k4, k5, k6, k7);
                        sum_to_d(d0, s0);
                        kernel_veritcal_2(src_ptr_v, (i+k*8), j+8, pad_size, src_col, k_ptr_v, s0, s1, s2, s3, s4, s5, s6, s7, k0, k1, k2, k3, k4, k5, k6, k7);
                        sum_to_d(d1, s0);
                        break;
                    case 3:
                        load_kernel_vertical_3(k_ptr_v + 8 * k, k0, k1, k2, k3, k4, k5, k6, k7);
                        kernel_veritcal_3(src_ptr_v, (i+k*8), j, pad_size, src_col, k_ptr_v, s0, s1, s2, s3, s4, s5, s6, s7, k0, k1, k2, k3, k4, k5, k6, k7);
                        sum_to_d(d0, s0);
                        kernel_veritcal_3(src_ptr_v, (i+k*8), j+8, pad_size, src_col, k_ptr_v, s0, s1, s2, s3, s4, s5, s6, s7, k0, k1, k2, k3, k4, k5, k6, k7);
                        sum_to_d(d1, s0);
                        break;
                    case 4:
                        load_kernel_vertical_4(k_ptr_v + 8 * k, k0, k1, k2, k3, k4, k5, k6, k7);
                        kernel_veritcal_4(src_ptr_v, (i+k*8), j, pad_size, src_col, k_ptr_v, s0, s1, s2, s3, s4, s5, s6, s7, k0, k1, k2, k3, k4, k5, k6, k7);
                        sum_to_d(d0, s0);
                        kernel_veritcal_4(src_ptr_v, (i+k*8), j+8, pad_size, src_col, k_ptr_v, s0, s1, s2, s3, s4, s5, s6, s7, k0, k1, k2, k3, k4, k5, k6, k7);
                        sum_to_d(d1, s0);
                        break;
                    case 5:
                        load_kernel_vertical_5(k_ptr_v + 8 * k, k0, k1, k2, k3, k4, k5, k6, k7);
                        kernel_veritcal_5(src_ptr_v, (i+k*8), j, pad_size, src_col, k_ptr_v, s0, s1, s2, s3, s4, s5, s6, s7, k0, k1, k2, k3, k4, k5, k6, k7);
                        sum_to_d(d0, s0);
                        kernel_veritcal_5(src_ptr_v, (i+k*8), j+8, pad_size, src_col, k_ptr_v, s0, s1, s2, s3, s4, s5, s6, s7, k0, k1, k2, k3, k4, k5, k6, k7);
                        sum_to_d(d1, s0);
                        break;
                        
                    case 6:
                        load_kernel_vertical_6(k_ptr_v + 8 * k, k0, k1, k2, k3, k4, k5, k6, k7);
                        kernel_veritcal_6(src_ptr_v, (i+k*8), j, pad_size, src_col, k_ptr_v, s0, s1, s2, s3, s4, s5, s6, s7, k0, k1, k2, k3, k4, k5, k6, k7);
                        sum_to_d(d0, s0);
                        kernel_veritcal_6(src_ptr_v, (i+k*8), j+8, pad_size, src_col, k_ptr_v, s0, s1, s2, s3, s4, s5, s6, s7, k0, k1, k2, k3, k4, k5, k6, k7);
                        sum_to_d(d1, s0);
                        break;
                        
                    case 7:
                        load_kernel_vertical_7(k_ptr_v + 8 * k, k0, k1, k2, k3, k4, k5, k6, k7);
                        kernel_veritcal_7(src_ptr_v, (i+k*8), j, pad_size, src_col, k_ptr_v, s0, s1, s2, s3, s4, s5, s6, s7, k0, k1, k2, k3, k4, k5, k6, k7);
                        sum_to_d(d0, s0);
                        kernel_veritcal_7(src_ptr_v, (i+k*8), j+8, pad_size, src_col, k_ptr_v, s0, s1, s2, s3, s4, s5, s6, s7, k0, k1, k2, k3, k4, k5, k6, k7);
                        sum_to_d(d1, s0);
                        break;
                ...
                store_d_vertical(dst_ptr_v+j*dst_col+i, dst_col, d0, d1);
            }
        }
...
void vertical_kernel_conv(int src_row, int src_col, float* src_ptr_v, int dst_row, int dst_col, float* dst_ptr_v, int ksize, const float* k_ptr_v) {
    ...
    parallel_for_(cv::Range(0, dst_row/16), ParallelVerticalConv(src_row, src_col, src_ptr_v, dst_row, dst_col, dst_ptr_v, ksize, k_ptr_v, num_of_simd_for_one_kernel, partial_SIMD_num));
