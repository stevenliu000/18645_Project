...
void vertical_kernel_conv(int src_row, int src_col, float* src_ptr_v, int dst_row, int dst_col, float* dst_ptr_v, int ksize, const float* k_ptr_v) {
    ...
    parallel_for_(cv::Range(0, dst_row), ParallelVerticalConv(src_row, src_col, src_ptr_v, dst_row, dst_col, dst_ptr_v, ksize, k_ptr_v, num_of_simd_for_one_kernel, partial_SIMD_num));
